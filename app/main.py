...
def login_screen():
    ...
    with st.container():
        ...
        # Feature badges - HORIZONTAL ROW (side by side)
        st.markdown("""
        <div style="display: flex; justify-content: center; gap: 0.8rem; flex-wrap: wrap; margin: 1.5rem 0;">
            <span style="background: rgba(31, 111, 235, 0.15); padding: 0.35rem 1rem; border-radius: 30px; font-size: 0.75rem; color: #58a6ff; border: 1px solid rgba(31, 111, 235, 0.3); white-space: nowrap;">🧠 AI-Powered Analysis</span>
            <span style="background: rgba(31, 111, 235, 0.15); padding: 0.35rem 1rem; border-radius: 30px; font-size: 0.75rem; color: #3fb950; border: 1px solid rgba(63, 185, 80, 0.3); white-space: nowrap;">📊 Clinical Grade</span>
            <span style="background: rgba(31, 111, 235, 0.15); padding: 0.35rem 1rem; border-radius: 30px; font-size: 0.75rem; color: #58a6ff; border: 1px solid rgba(31, 111, 235, 0.3); white-space: nowrap;">🩻 Chest X-Ray</span>
            <span style="background: rgba(31, 111, 235, 0.15); padding: 0.35rem 1rem; border-radius: 30px; font-size: 0.75rem; color: #f85149; border: 1px solid rgba(248, 81, 73, 0.3); white-space: nowrap;">⚡ Real-Time Detection</span>
        </div>
        """, unsafe_allow_html=True)
